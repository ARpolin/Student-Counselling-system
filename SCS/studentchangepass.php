...
if(empty($_POST)===false)
{
  ...
  if (md5($_POST['currentpassword'])===$suserdata['password']) 
  {
         ...
         <div id="page-content-wrapper">
            <div class="container-fluid">
                ...
                if (isset($_GET['success'])&& empty($_GET['success'])) 
                {
                    ...
                    {       
                        student_change_password($ssession_user_id,$_POST['newpassword']);
                        header('Location:studentchangepass.php?success');
                        exit();
                    }
