...
<body style="background:#FFFFF0">
    ...
    <!-- Navigation -->
    <nav class="navbar navbar-default navbar-fixed-top" role="navigation"style="background:#1975A3">
        <div class="container">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="#" style="color:#FFFFFF">HomePage</a>
            </div>
...
<div id="all_comments">
  ...
  <div style="margin-top: 25px;"class="panel panel-info">
      ...
      <div class="panel-heading"><h4 class="name">Title:<?php echo  $title;?></h4></div>
      <div class="panel-body"><h3 class="comment"><?php echo $notice;?></h3></div>
