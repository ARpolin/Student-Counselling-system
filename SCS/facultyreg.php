...
if(empty($_POST)===false)
{
 ...
 if (empty($error)===true) {
   if (facultyuserid_exists($_POST['userid'])===true) {
     $error[]='Sorry,the userID\''.$_POST['userid'].'\' is already taken.';
   }
   if (strlen($_POST['userid'])<11) {
         ...
         <div id="page-content-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <!--OverView-->
                    <div class="col-lg-12">
                        <div class="well well-sm" style="text-align:center;background:#09bfe0;"><strong>Faculty Registration</strong> </div>
                    </div>
                    <?php
                            ...
                            if (empty($_POST)===false && empty($error)===true) 
                        {
                            ...
                            register_faculty($register_data);
                            header('Location:facultyreg.php?success');
                            exit();
                        }
