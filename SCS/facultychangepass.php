...
if(empty($_POST)===false)
{
  ...
  if (md5($_POST['currentpassword'])===$fuserdata['password']) 
  {
         ...
         <div id="page-content-wrapper">
            <div class="container-fluid">
                ...
                if (isset($_GET['success'])&& empty($_GET['success'])) 
                {
                    ...
                    {       
                        faculty_change_password($fsession_user_id,$_POST['newpassword']);
                        header('Location:facultychangepass.php?success');
                        exit();
                    }
