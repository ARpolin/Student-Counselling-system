            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-lg-12 col-md-offset overview">
                        ...
                        <div class="well well-sm" style="text-align:center;background:#09bfe0;"><strong>Appointment Request</strong></div> 
                    </div>
                     ...
                     <div class="col-md-12">         
                        <table class="table table-hover">
                            ...
                            while($row=mysql_fetch_array($result))
                            {
                                ...
                                echo "<td>" .$fname. "</td>";
                                echo "<td>
                                    <input type=\"button\" value=\" Request\"class=\"btn btn-primary\" data-toggle=\"modal\" data-target=\"#myModal\">
                                </td>";
                                echo '</form>';
      ...
      <div class="modal-dialog">
        ...
        <div class="modal-content">
          <div class="modal-header">
            ...
            <h4 class="modal-title">Request Section</h4>
          </div>
